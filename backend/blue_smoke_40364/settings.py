"""
Django settings for blue_smoke_40364 project.
...
ROOT_URLCONF = 'blue_smoke_40364.urls'
...
WSGI_APPLICATION = 'blue_smoke_40364.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_smoke_40364 API",
    "DESCRIPTION": "API documentation for blue_smoke_40364 App",
    "VERSION": "v1",
}
